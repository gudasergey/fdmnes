...
! One keeps the values of the current iteration, to use them in the next one
  ...
  150 format(12x,' Total energy =',f13.1,' eV, Delta energy =',f11.3,' ',a1,f8.3,' eV,  Weight =',f8.5,'. Converged !')
  155 format(/' Cycle',i4,': Total energy =',f15.1,' eV, Delta energy =',f11.3,' ',a1,f8.3,' eV,  Weight =',f8.5,'. Converged !')
  160 format(/' New Fermi optimization with imaginary energy divided by',i2)
  162 format(12x,' Total energy =',f13.1,' eV, Delta energy =',f11.3,' ',a1,f8.3,' eV,  Weight =',f8.5,', Mod_p =',i2)
  165 format(/' Cycle',i4,': Total energy =',f15.1,' eV, Delta energy =',f11.3,' ',a1,f8.3,' eV,  Weight =',f8.5,', Mod_p =',i2)
